...
const DiscCard = () => {
    ...
    return (
        <aside className="w-[30rem] xl:h-44 h-36 p-4 rounded-lg relative overflow-hidden box-border flex bg-gradient-to-t to-primary from-tertiary text-white" onMouseEnter={() => setIsHovered(1)} onMouseLeave={() => setIsHovered(null)}>
            ...
            <div className="w-2/4 overflow-hidden ">
                <img src="/image/cardCar.png" alt="" className="absolute xl:top-0 xl:left-28 -top-5 left-20" />
            </div>
        </aside>
    )
}
